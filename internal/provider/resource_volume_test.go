...
func TestVolumeResource_basic(t *testing.T) {
	...
	volumeInstancesResp := fmt.Sprintf(`{"data":{"project":{"volumes":{"edges":[{"node":{"id":"vol-123","name":"my-volume","volumeInstances":{"edges":[{"node":{"environmentId":"%s","serviceId":"%s","mountPath":"/data","sizeMB":1024}}]}}}]}}}}`, envId, serviceId)
...
func TestVolumeResource_withName(t *testing.T) {
	...
	volumeInstancesResp := fmt.Sprintf(`{"data":{"project":{"volumes":{"edges":[{"node":{"id":"vol-456","name":"postgres-data","volumeInstances":{"edges":[{"node":{"environmentId":"%s","serviceId":"%s","mountPath":"/var/lib/postgresql/data","sizeMB":2048}}]}}}]}}}}`, envId, serviceId)
...
func TestVolumeResource_import(t *testing.T) {
	...
	volumeInstancesResp := fmt.Sprintf(`{"data":{"project":{"volumes":{"edges":[{"node":{"id":"vol-789","name":"my-volume","volumeInstances":{"edges":[{"node":{"environmentId":"%s","serviceId":"%s","mountPath":"/data","sizeMB":512}}]}}}]}}}}`, envId, serviceId)
